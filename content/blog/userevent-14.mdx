...
user.pointer({target: screen.getByRole('button')})

// Double click at current position
user.pointer('[MouseLeft][MouseLeft]')
...
user.pointer('[MouseLeft]') // a click with shiftKey=true
```
